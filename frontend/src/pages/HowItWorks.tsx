...
export default function HowItWorks() {
  ...
  return (
    <div>
      {/* Hero */}
      <section
        className="bg-[#fcf8f1] border-b border-[#e4e1da] py-16 md:py-20"
      ...
      >
        <div className="max-w-3xl mx-auto px-4 md:px-8 text-center">
          ...
          <h1
            id="hiw-heading"
            className="text-4xl md:text-5xl font-bold text-[#252932] mb-5"
          ...
          <p className="text-lg text-[#5f6673] leading-relaxed">
            ...
            tiên, hệ thống tìm các bài thơ liên quan trong kho dữ liệu và sử
            dụng chúng làm ngữ cảnh sáng tác.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20" aria-labelledby="pipeline-heading">
        <div className="max-w-5xl mx-auto px-4 md:px-8 lg:px-12">
          <h2
            id="pipeline-heading"
            className="text-2xl md:text-3xl font-bold text-[#252932] text-center mb-12"
          >
            ...
            {steps.map((step, i) => (
              <li key={step.num} className="flex gap-5 items-start group">
                <div className="flex-shrink-0 flex flex-col items-center">
                  ...
                  {i < steps.length - 1 && (
                    <div
                      className="w-0.5 h-8 bg-[#e4e1da] mt-2"
                      aria-hidden="true"
                    />
                  )}
                </div>
                <div className="flex-1 pt-2">
                  <div className="flex items-center gap-3 mb-1.5">
                    <span className="text-xs font-bold text-[#7d8490] font-mono">
                      {step.num}
                    </span>
                    <h3 className="font-semibold text-[#252932] text-lg">
                      {step.title}
                    </h3>
                  </div>
      ...
      >
        <div className="max-w-5xl mx-auto px-4 md:px-8 lg:px-12">
          <h2
            ...
            className="text-2xl md:text-3xl font-bold text-[#252932] text-center mb-4"
          >
            Phương pháp truy xuất
          </h2>
          <p className="text-center text-[#5f6673] mb-10 max-w-xl mx-auto">
            Dự án benchmarks nhiều phương pháp truy xuất để tìm ra cách hiệu quả
            nhất cho thi ca tiếng Việt.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {retrievalMethods.map((method) => (
              <div
                key={method.name}
                className="bg-white rounded-xl border border-[#e4e1da] p-6"
              >
                <div className="flex items-center gap-3 mb-3">
                  <Badge variant={method.variant}>{method.badge}</Badge>
                  <h3 className="font-semibold text-[#252932]">
                    {method.name}
                  </h3>
                </div>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#f2f4f8] rounded-xl p-5 border border-[#d5d2ca]">
              <p className="text-xs font-bold text-[#7d8490] uppercase tracking-wide mb-3">
                Yêu cầu người dùng
              </p>
              <p className="text-sm text-[#252932] font-medium mb-1">
                Câu thơ mở đầu:
              </p>
              <p className="text-base italic font-serif text-[#3f4a6b] mb-3">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={s} className="flex gap-2 items-start">
                    <span className="text-xs text-[#7d8490] font-mono flex-shrink-0">
                      #{i + 1}
                    </span>
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={limit} className="flex gap-3 text-[#5f6673] text-sm">
                <span className="flex-shrink-0 text-[#a36a22] font-bold">
                  ⚠
                </span>
                {limit}
              </li>
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-8">
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div
                key={i}
                className="bg-white border border-[#e4e1da] rounded-xl overflow-hidden"
              >
                <button
                ...
                >
                  <span className="font-medium text-[#252932] text-sm pr-4">
                    {faq.q}
                  </span>
                  <svg
                    width="16"
      ...
      <section className="py-12 border-t border-[#e4e1da] text-center">
        ...
        <Button size="lg" onClick={() => navigate("/sang-tac")}>

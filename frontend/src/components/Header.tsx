    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-[#e4e1da]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-[#3f4a6b] flex items-center justify-center flex-shrink-0">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                />
                <path
                  d="M7 8h2v8H7V8zm8 0h2v8h-2V8z"
                  fill="none"
                />
                <text x="6" y="16" fill="#d6b98c" fontSize="12" fontFamily="serif">詩</text>
              </svg>
            </div>
            <span className="font-bold text-[#252932] text-lg tracking-tight">Thi Vận AI</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full bg-[#4f7a68]" aria-hidden="true" />
              Nghiên cứu
            </Link>
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-[#e4e1da] bg-white px-4 py-3 flex flex-col gap-1">
          ...
          >
            <span className="w-2 h-2 rounded-full bg-[#4f7a68]" aria-hidden="true" />
            Chế độ nghiên cứu
          </Link>
        </div>
      )}

...
class Settings(BaseSettings):
    ...
    ANALYSIS_TEMPERATURE: float = Field(default=0.2, ge=0.0, le=2.0)
    ANALYSIS_MAX_OUTPUT_TOKENS: int = Field(default=1600, ge=256, le=8192)
    ANALYSIS_TIMEOUT_SECONDS: int = Field(default=90, ge=1, le=600)
